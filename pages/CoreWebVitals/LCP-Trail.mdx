...
> **Need timing breakdowns?** Use [LCP Subparts](/CoreWebVitals/LCP-Subparts) to identify which phase (TTFB, load delay, load time, render delay) is causing the bottleneck.
